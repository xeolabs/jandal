...
public class RandomHaikuServiceSet extends ServiceSet {
	public RandomHaikuServiceSet() {
		this.addService("randomHaikuService", new RandomHaikuService("randomHaikuService"));
	}
}
