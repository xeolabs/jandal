This is RandomHaiku, a demonstration application built using the Jandal Web Application Framework.
...
this application out in your browser at 
   ...
   http://localhost:8080/jandal-randomhaiku

where "jandal-randomhaiku" is the value for the "project.distName" property
