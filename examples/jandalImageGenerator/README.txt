This is ImageGenerator, a demonstration application built using the Jandal Web Application Framework.
...
6.	Stop Jetty, deploy, then start Jetty (clean, build and 
	package first):
...
this application out in your browser at 
   ...
   http://localhost:8080/jandal-imagegen

where "jandal-imagegen" is the value for the "project.distName" property
