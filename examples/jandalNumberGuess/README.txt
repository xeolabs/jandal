This is NumberGuess, a demonstration application built using the Jandal Web Application Framework.
...
reports               ANT-generated unit test reports
...
3. 	Run any unit tests (clean and build first):

		ant test

4.	Generate war file (clean, build and test first):

		ant package

5.	Deploy to Jetty, but do not start Jetty 
	(clean, build, test and package first):

		ant deploy

6.	Stop Jetty, deploy, then start Jetty (clean, build, test and 
	package first):
...
where "numberguess" is the value for the "project.distName" property
