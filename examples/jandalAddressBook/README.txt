This is AddressBook, a demonstration application built using the Jandal Web Application Framework.
...
4.	Deploy to Jetty, but do not start Jetty 
	(clean, build and package first):

		ant deploy

5.	Stop Jetty, deploy, then start Jetty (clean, build and 
	package first):
...
this application out in your browser at 
   ...
   http://localhost:8080/jandal-addressbook

where "jandal-addressbook" is the value for the "project.distName" property
