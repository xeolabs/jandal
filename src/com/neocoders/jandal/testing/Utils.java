...
class Utils {
	...
	if (name == null) {
	    throw new JandalUnitException(description + " is null");
	}
	name = name.trim();
	if (name.length() == 0) {
	    throw new JandalUnitException(description + " is zero length");
	}
	return name;
    }

    public static String validateNameOkEmpty(String name,
	    String description) throws JandalUnitException {
	if (name == null) {
	    throw new JandalUnitException(description + " is null");
	}
	name = name.trim();
