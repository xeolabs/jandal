 ...
 */
package com.neocoders.jandal.examples.treeMap.frame;

import com.neocoders.jandal.core.*;
import com.neocoders.jandal.examples.treeMap.frame.cell.CellController;

public class RootController extends Controller {

	public RootController(String name) throws JandalCoreException {
		super(name);
	}
	...
	protected void onStart() throws JandalCoreException {
		this.addInitialState(new State("initialState") {
			...
			protected void onEntry() throws JandalCoreException {
				...
				this.addChildController(new CellController("root", 400, 300,
						true, "#9999FF"));

				this.addViewEventProcessor(new EventProcessor("clear") {
					protected void onEvent() throws JandalCoreException {
						doTransition("initialState");
					}
				});
			}
		});
