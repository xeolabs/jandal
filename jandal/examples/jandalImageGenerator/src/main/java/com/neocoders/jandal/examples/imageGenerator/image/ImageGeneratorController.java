...
public class ImageGeneratorController extends Controller {

	public ImageGeneratorController(String arg0) throws JandalCoreException {
		super(arg0);
	}
	...
	protected void onStart() throws JandalCoreException {
		...
		this.addInitialState(new State("mainState") {
			...
			protected void onEntry() throws JandalCoreException {
				setOutput("template", "image.ftl");
				setOutput("image", new Image(""));

				this.addParentEventProcessor(new EventProcessor("generate") {
