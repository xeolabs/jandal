 ...
 */
package com.neocoders.jandal.examples.randomHaiku.app.frame;
...
import com.neocoders.jandal.examples.randomHaiku.app.frame.haiku.HaikuMasterController;

public class FrameController extends Controller {

	public FrameController(String name) throws JandalCoreException {
		super(name);
	}
	...
	protected void onStart() throws JandalCoreException {
		this.addInitialState(new State("initialState") {
			...
			protected void onEntry() throws JandalCoreException {
				...
				this.addChildController(new HaikuMasterController());
			}
		});
	}
}
